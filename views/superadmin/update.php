...
// Initialize error variables if not already set
$err_fname = $err_fname ?? "";
$err_lname = $err_lname ?? "";
$err_uname = $err_uname ?? "";
$err_email = $err_email ?? "";
        ...
        <div>
          <div class="login p-l-55 p-r-55 p-t-65 p-b-50">
            <form action="" class="login-form" method="post">
              ...
              <input class="login-input" name="email" type="email" placeholder="Email Address" value="<?php echo $admin["email"]; ?>" />
              <span style="color:red"><?php echo $err_email; ?></span>
              <br />

              <input class="login-input" name="phone" type="text" placeholder="Phone Number" value="<?php echo $admin["phone"]; ?>" />
