...
if (!isset($cfpass)) $cfpass = "";
if (!isset($err_cpass)) $err_cpass = "";
if (!isset($wrong_cpass)) $wrong_cpass = "";
if (!isset($err_npass)) $err_npass = "";
if (!isset($err_cfpass)) $err_cfpass = "";
if (!isset($wrong_pass)) $wrong_pass = "";
?>
<!DOCTYPE html>
<html lang="en">
  <head>
